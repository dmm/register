...
export class CheckoutComponent {
    @ViewChild('itemList', { static: false }) private itemList: ElementRef = {} as ElementRef;
    ...
    scrollToBottom() {
        this.itemList.nativeElement.scrollTop = this.itemList.nativeElement.scrollHeight;
    }
    ...
    openPaymentDialog(enterAnimationDuration: string, exitAnimationDuration: string): void {
...
export class PaymentDialog {
    ...
    constructor(nfcService: NfcService, public dialogRef: MatDialogRef<PaymentDialog>, @Inject(MAT_DIALOG_DATA) public data: DialogData,) {
        this.data = {
